...
import org.sonarsource.scala.gradle.AnalyzerLicensingPackagingRenderer
import org.sonarsource.scala.gradle.areDirectoriesEqual
import org.sonarsource.scala.gradle.copyDirectory
 ...
 * This tasks expects the license of the project to be present one level above the (project-)plugin directory.
 */
